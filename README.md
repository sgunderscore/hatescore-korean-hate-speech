...
- 본 데이터는 [(Kang, Tayoung, et al., 2022)](https://github.com/sgunderscore)에서 다루는 SmilegateAI의 [Korean Unsmile Dataset](https://github.com/smilegate-ai/korean_unsmile_dataset)의 혐오 발언 분류 모델을 기반으로 하며 중립 문장 오분류 방지 목적에 중점을 두고 개발되었습니다.
