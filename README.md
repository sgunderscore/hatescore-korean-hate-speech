...
- 본 깃헙 페이지는 [(Kang, Tayoung, et al., 2022)](https://github.com/sgunderscore) 논문에서 활용한 데이터셋 중 부가 데이터 1.1만건을 다룹니다. 논문의 메인 데이터셋인 [SmilegateAI Korean Unsmile Dataset](https://github.com/smilegate-ai/korean_unsmile_dataset)은 Smilegate AI의 기획과 지원을 바탕으로 개발되었습니다.
- 본 HateScore 데이터셋의 크기는 약 1.1만 건으로, SmilegateAI Korean Unsmile Dataset의 base model을 활용해 HITL(Human-in-the-Loop) 방식으로 태깅된 1.7천 건, 위키피디아에서 수집한 혐오 이슈 관련 중립 문장 2.2천 건, 규칙 기반으로 생성된 중립 문장 7.1천 건의 세 가지로 구성됩니다.
- 언더스코어는 SmilegateAI Korean Unsmile Dataset의 개발과 레이블링 작업을 진행했으며, 본 HateScore 데이터셋 역시 당시의 참여 인원 및 레이블링 기준을 동일하게 유지했습니다. 다만 이하의 '4.권장사항' 및 '5.FAQ' 항목에 작성된 내용은 SmilegateAI와는 별개로, 언더스코어가 독립적으로 작성한 의견입니다.
